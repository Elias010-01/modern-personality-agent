...
BITS 16
    ...
    mov al, 0xff                             ; B0 FF
    cmp bl, 0x54                             ; 80 FB 54
    db 073h, 03Ch                     ; jae 0x185
    mov al, byte cs:[bx + 0x330]             ; 2E 8A 87 30 03
    ...
    mov al, byte cs:[bx + 0x33d]             ; 2E 8A 87 3D 03
    ...
    db 036h, 036h, 026h, 01Eh         ; push ds
    aaa                                      ; 37
    aaa                                      ; 37
    das                                      ; 2F
    db 0FFh                           ; FF
    ...
    db 02Eh                           ; 2E
    db 0FFh                           ; FF
    mov bx, 0x3f2b                           ; BB 2B 3F
    db 0FFh                           ; FF
    mov sp, 0x3b2c                           ; BC 2C 3B
    db 0FFh                           ; FF
    mov bp, 0x5f2d                           ; BD 2D 5F
    lahf                                     ; 9F
    mov si, 0x3a2e                           ; BE 2E 3A
    db 0FFh                           ; FF
    mov dx, 0x2a27                           ; BA 27 2A
    db 0FFh                           ; FF
    ...
    out 0xc6, al                             ; E6 C6
    db 0FFh                           ; FF
    db 0DCh, 0F8h                     ; fdiv st(0), st(0)
    db 0D8h, 0FFh                     ; fdivr st(7)
    db 0DDh, 0E5h                     ; fucom st(5)
    lds bx, [bp + di]                        ; C5 1B
    fisubr word [bx + si + 0x1d5e]           ; DE A8 5E 1D
    push 0x2a                                ; 6A 2A
    ...
    xor byte [bp + di + 0x8c0], bh           ; 30 BB C0 08
    ...
    dec sp                                   ; 4C
    db 0DCh                           ; DC
    db 0DBh, 0BFh, 010h, 0BAh         ; fstp xword [bx - 0x45f0]
    pop dx                                   ; 5A
    pop ax                                   ; 58
    inc bx                                   ; 43
    push si                                  ; 56
    ...
    db 070h, 071h                     ; jo 0x3de
    db 072h, 073h                     ; jb 0x3e2
    db 074h, 075h                     ; je 0x3e6
    db 076h, 077h                     ; jbe 0x3ea
    db 078h, 079h                     ; js 0x3ee
    nop                                      ; 90
    xchg cx, ax                              ; 91
    and al, 0x26                             ; 24 26
    ...
    db 02Eh, 067h, 068h, 069h, 06Dh   ; push 0x6d69
    ...
    and si, word [0x5e5e]                    ; 23 36 5E 5E
    aaa                                      ; 37
    db 026h, 026h, 038h, 02Ah         ; cmp byte es:[bp + si], ch
    sub bh, byte [bx + di]                   ; 2A 39
    sub byte [bx + si], ch                   ; 28 28
    mov bx, 0x5f2d                           ; BB 2D 5F
    mov sp, 0x3c3c                           ; BC 3C 3C
    mov bp, 0x3f2f                           ; BD 2F 3F
    mov si, 0x3e3e                           ; BE 3E 3E
    mov dx, 0x7e60                           ; BA 60 7E
    mov di, 0x7c5c                           ; BF 5C 7C
    sar byte [di], 0x2b                      ; C0 3D 2B
    db 0DBh                           ; DB
    daa                                      ; 27
    db 022h, 0DCh                     ; and bl, ah
    cmp di, word [bp + si]                   ; 3B 3A
    fstp qword [bp + di + 0x7b]              ; DD 5B 7B
    ficomp word [di + 0x7d]                  ; DE 5D 7D
    db 0FFh                           ; FF
    db 0FFh                           ; FF
    ...
    popaw                                    ; 61
    db 0E0h, 0E1h                     ; loopne 0x3b4
    db 0E2h, 0E4h                     ; loop 0x3b9
    db 065h, 0E8h, 0E9h, 0EAh         ; call 0xffffeec2
    db 0EBh, 069h                     ; jmp 0x444
    in al, dx                                ; EC
    in ax, dx                                ; ED
    out dx, al                               ; EE
    out dx, ax                               ; EF
    ...
    db 0FFh                           ; FF
    db 0FFh                           ; FF
    fild dword [bx + si]                     ; DB 00
    fadd qword [bx + si]                     ; DC 00
    fld qword [bx + si]                      ; DD 00
    db 0FFh                           ; FF
    inc word [bx]                            ; FF 07
