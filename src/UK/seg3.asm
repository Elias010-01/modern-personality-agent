...
BITS 16
    ...
    daa                                      ; 27
    inc ax                                   ; 40
    sbb bl, 0x5b                             ; 80 DB 5B
    db 07Bh, 01Bh                     ; jnp 0x32f
    fcomp qword [si + 0x7c]                  ; DC 5C 7C
    sbb al, 0xdd                             ; 1C DD
    pop bp                                   ; 5D
    db 07Dh, 01Dh                     ; jge 0x339
    fisub word [bp + di]                     ; DE 23
    db 07Eh, 0FFh                     ; jle 0x31f
    db 0DFh, 060h, 0ACh               ; fbld tbyte [bx + si - 0x54]
    ...
    db 0FFh                           ; FF
    db 0FFh                           ; FF
    fdivr qword [bp + si + 0x7b]             ; DC 7A 7B
