; AUTO-GENERATED from original TERMINAL segment 7
...
TERMINAL_TEXT SEGMENT BYTE PUBLIC 'CODE'
        ...
        mov     word ptr [0x1b5a], ax           ; A3 5A 1B
        mov     ax, word ptr [bp + 0x12]        ; 8B 46 12
        mov     word ptr [0x200a], ax           ; A3 0A 20
        mov     ax, word ptr [bp + 0x10]        ; 8B 46 10
        mov     word ptr [0x1cbe], ax           ; A3 BE 1C
        mov     ax, word ptr [bp + 0xe]         ; 8B 46 0E
        mov     word ptr [0x200c], ax           ; A3 0C 20
        mov     ax, word ptr [bp + 0xc]         ; 8B 46 0C
        sub     ax, 7                           ; 2D 07 00
        mov     word ptr [0x1b10], ax           ; A3 10 1B
        mov     ax, word ptr [bp + 0xa]         ; 8B 46 0A
        mov     word ptr [0x2042], ax           ; A3 42 20
        mov     ax, word ptr [bp + 8]           ; 8B 46 08
        mov     word ptr [0x1bfa], ax           ; A3 FA 1B
        mov     ax, word ptr [bp + 6]           ; 8B 46 06
        mov     word ptr [0x1c10], ax           ; A3 10 1C
...
L_00A9:
        ...
        push    word ptr [0x1b5a]               ; FF 36 5A 1B
        mov     ax, word ptr [0x200c]           ; A1 0C 20
        inc     ax                              ; 40
        push    ds                              ; 1E
        push    ax                              ; 50
        ...
        push    ax                              ; 50
        push    word ptr [0x1b10]               ; FF 36 10 1B
        sub     ax, ax                          ; 2B C0
        push    ax                              ; 50
        push    ax                              ; 50
        ...
        push    ds                              ; 1E
        push    ax                              ; 50
        push    word ptr [0x200a]               ; FF 36 0A 20
        push    word ptr [0x1cbe]               ; FF 36 BE 1C
...
L_015A:
        push    word ptr [bp + 0xe]             ; FF 76 0E
        push    word ptr [0x1b5a]               ; FF 36 5A 1B
        mov     ax, word ptr [0x2042]           ; A1 42 20
        push    ds                              ; 1E
        push    ax                              ; 50
        push    word ptr [0x1b10]               ; FF 36 10 1B
...
L_01C5:
        ...
        jmp     L_0391                          ; E9 B8 01
L_01D9:
        push    word ptr [0x2042]               ; FF 36 42 20
        sub     ax, ax                          ; 2B C0
        push    ax                              ; 50
...
L_01F9:
        ...
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     ax, word ptr [0x1bfa]           ; A1 FA 1B
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     ax, 0x2800                      ; B8 00 28
        push    ax                              ; 50
        call    far KERNEL.OPENFILE             ; 9A FF FF 00 00 [FIXUP]
        mov     bx, word ptr [0x1c10]           ; 8B 1E 10 1C
        mov     word ptr [bx], ax               ; 89 07
        cmp     ax, 0xffff                      ; 3D FF FF
        jne     L_0243                          ; 75 0F
        mov     bx, word ptr [0x1bfa]           ; 8B 1E FA 1B
...
L_032E:
        ...
        mov     cx, word ptr [0x2042]           ; 8B 0E 42 20
        add     ax, cx                          ; 03 C1
        mov     dx, ds                          ; 8C DA
        push    dx                              ; 52
        push    ax                              ; 50
...
L_04A2:
        ...
        add     ax, word ptr [0x200c]           ; 03 06 0C 20
        push    ds                              ; 1E
        push    ax                              ; 50
