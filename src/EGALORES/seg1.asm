; AUTO-GENERATED from original EGALORES segment 1
; segment_size=10330 bytes, flags=0x0040
...
EGALORES_TEXT SEGMENT BYTE PUBLIC 'CODE'
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_015D -- offset 0x015D -- 36 instr
; Llama a servicios BIOS via INT 10h (video, 36 instr).
; tags: bios_caller, int_10
; callers: sub_2552
; calls (intra): sub_01AA
;----------------------------------------------------------------------
L_015D:
        ...
        mov     di, 0x78                        ; BF 78 00
        xor     al, al                          ; 32 C0
        mov     byte ptr es:[0x10], al          ; 26 A2 10 00
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01AA -- offset 0x01AA -- 9 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01B6 -- offset 0x01B6 -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; callers: sub_26A5, sub_271F
; calls (intra): sub_0210, sub_0258, sub_031B, sub_03A7, sub_043D, sub_051C (+2 mas)
;----------------------------------------------------------------------
L_01B6:
        mov     ax, ds                          ; 8C D8
        mov     es, ax                          ; 8E C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01D6 -- offset 0x01D6 -- 12 instr
; Funcion sin clasificar definitiva (12 instr).
; tags: small
; callers: sub_2426, sub_24B2, sub_2682, sub_2769
; calls (intra): sub_01F3, sub_051C, sub_0541
;----------------------------------------------------------------------
L_01D6:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01F3 -- offset 0x01F3 -- 11 instr
; Wrapper que delega en sub_04F2.
; tags: wrapper
; callers: sub_01D6, sub_043D
; calls (intra): sub_04F2
;----------------------------------------------------------------------
L_01F3:
        mov     di, 0x3e80                      ; BF 80 3E
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0210 -- offset 0x0210 -- 16 instr
; Funcion sin clasificar definitiva (16 instr).
; tags: small
; callers: sub_01B6
; calls (intra): sub_023B, sub_0385, sub_0536
;----------------------------------------------------------------------
L_0210:
        ...
        mov     si, 0x78                        ; BE 78 00
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_023B -- offset 0x023B -- 15 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0258 -- offset 0x0258 -- 15 instr
; Wrapper que delega en sub_027D.
; tags: wrapper
; callers: sub_01B6
; calls (intra): sub_027D
;----------------------------------------------------------------------
L_0258:
        mov     ax, ds                          ; 8C D8
        mov     es, ax                          ; 8E C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_02CB -- offset 0x02CB -- 42 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0355 -- offset 0x0355 -- 26 instr
...
L_0385:
        ...
        add     si, cx                          ; 03 F1
        add     si, ax                          ; 03 F0
        add     si, 0x3ed0                      ; 81 C6 D0 3E
        mov     cx, 0x10                        ; B9 10 00
        ret                                     ; C3
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_03A7 -- offset 0x03A7 -- 63 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_043D -- offset 0x043D -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; callers: sub_01B6
; calls (intra): sub_01F3, sub_0355, sub_045D, sub_0492
;----------------------------------------------------------------------
L_043D:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_045D -- offset 0x045D -- 33 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0492 -- offset 0x0492 -- 36 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_04F2 -- offset 0x04F2 -- 23 instr
; Funcion sin clasificar definitiva (23 instr).
; tags: small
; callers: sub_01F3, sub_0492
;----------------------------------------------------------------------
L_04F2:
        xchg    si, ax                          ; 96
        sar     si, 1                           ; D1 FE
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_052A -- offset 0x052A -- 6 instr
; Funcion hoja (no llama a otras, 6 instr): probable helper aritmetico/conversion.
; tags: leaf
; callers: sub_01B6
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0536 -- offset 0x0536 -- 6 instr
; Funcion hoja (no llama a otras, 6 instr): probable helper aritmetico/conversion.
; tags: leaf
; callers: sub_0210, sub_0EC6, sub_1CEE
;----------------------------------------------------------------------
L_0536:
        mov     al, 3                           ; B0 03
        mov     dx, 0x3ce                       ; BA CE 03
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0541 -- offset 0x0541 -- 1093 instr
; Iterador con instrucciones de string (movsb/scasb/...) (1093 instr).
; tags: complex_iterator, far, loop, string_op
; callers: sub_01B6, sub_01D6
; calls (intra): sub_0EC6, sub_2426, sub_24B2, sub_282C
;----------------------------------------------------------------------
L_0541:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0EC6 -- offset 0x0EC6 -- 1459 instr
; Iterador con instrucciones de string (movsb/scasb/...) (1459 instr).
; tags: complex_iterator, far, loop, string_op
; callers: sub_0541
; calls (intra): sub_0536, sub_1C1F, sub_1CEE, sub_2327, sub_2426, sub_24B2 (+1 mas)
;----------------------------------------------------------------------
L_0EC6:
        mov     ah, ch                          ; 8A E5
        mov     al, 8                           ; B0 08
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1C1F -- offset 0x1C1F -- 71 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1CEE -- offset 0x1CEE -- 348 instr
; Iterador con instrucciones de string (movsb/scasb/...) (348 instr).
; tags: complex_iterator, far, loop, string_op
; callers: sub_0EC6
; calls (intra): sub_0536, sub_2426
;----------------------------------------------------------------------
L_1CEE:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2036 -- offset 0x2036 -- 49 instr
; Funcion mediana (49 instr, 1 calls).
; tags: medium
; callers: sub_20B4
; calls (intra): sub_20B4
;----------------------------------------------------------------------
L_2036:
...
L_2159:
        ...
        xor     si, si                          ; 33 F6
        mov     dx, cx                          ; 8B D1
        call    L_27EE                          ; E8 72 06
        pop     dx                              ; 5A
        call    L_27EE                          ; E8 6E 06
        pop     dx                              ; 5A
        call    L_27EE                          ; E8 6A 06
        or      si, si                          ; 0B F6
        je      L_21AB                          ; 74 23
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_225F -- offset 0x225F -- 90 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2322 -- offset 0x2322 -- 2 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2327 -- offset 0x2327 -- 128 instr
; Iterador con instrucciones de string (movsb/scasb/...) (128 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2426 -- offset 0x2426 -- 26 instr
; Funcion sin clasificar definitiva (26 instr).
; tags: small
; callers: sub_0541, sub_0EC6, sub_1CEE
; calls (intra): sub_01D6, sub_247A
;----------------------------------------------------------------------
L_2426:
        mov     ds, word ptr cs:[0x25f5]        ; 2E 8E 1E F5 25
        and     cl, 0xf8                        ; 80 E1 F8
        or      si, 7                           ; 81 CE 07 00
        mov     word ptr [0xca], cx             ; 89 0E CA 00
        mov     word ptr [0xcc], dx             ; 89 16 CC 00
        mov     word ptr [0xce], si             ; 89 36 CE 00
        mov     word ptr [0xd0], di             ; 89 3E D0 00
        mov     byte ptr [0xc9], 1              ; C6 06 C9 00 01
        mov     cl, 0xc0                        ; B1 C0
        pushf                                   ; 9C
        cli                                     ; FA
        mov     ax, word ptr [0x16]             ; A1 16 00
        ...
        je      L_2472                          ; 74 19
        xor     cx, cx                          ; 33 C9
        xchg    byte ptr [0xda], cl             ; 86 0E DA 00
        push    cx                              ; 51
        mov     byte ptr [0xc8], 0x40           ; C6 06 C8 00 40
        sti                                     ; FB
        call    L_01D6                          ; E8 6D DD
        mov     ds, word ptr cs:[0x25f5]        ; 2E 8E 1E F5 25
        pop     ax                              ; 58
        mov     byte ptr [0xda], al             ; A2 DA 00
L_2472:
        jmp     L_2475                          ; EB 01
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2474 -- offset 0x2474 -- 4 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_247A -- offset 0x247A -- 20 instr
; Funcion hoja (no llama a otras, 20 instr): probable helper aritmetico/conversion.
; tags: leaf
; callers: sub_2426, sub_2682, sub_271F
;----------------------------------------------------------------------
L_247A:
        mov     ds, word ptr cs:[0x25f5]        ; 2E 8E 1E F5 25
        test    byte ptr [0xc8], cl             ; 84 0E C8 00
        jne     L_24B1                          ; 75 2C
        xor     cx, cx                          ; 33 C9
        cmp     byte ptr [0xc9], cl             ; 38 0E C9 00
        je      L_24AE                          ; 74 21
        cmp     ax, word ptr [0xce]             ; 3B 06 CE 00
        jg      L_24AE                          ; 7F 1B
        add     ax, word ptr [0x26]             ; 03 06 26 00
        cmp     ax, word ptr [0xca]             ; 3B 06 CA 00
        jl      L_24AE                          ; 7C 11
        cmp     bx, word ptr [0xd0]             ; 3B 1E D0 00
        jg      L_24AE                          ; 7F 0B
        add     bx, 0xf                         ; 81 C3 0F 00
        cmp     bx, word ptr [0xcc]             ; 3B 1E CC 00
        jl      L_24AE                          ; 7C 01
        inc     cx                              ; 41
L_24AE:
        or      cx, cx                          ; 0B C9
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_24B2 -- offset 0x24B2 -- 69 instr
; Funcion mediana (69 instr, 1 calls).
; tags: far, medium
; callers: sub_0541, sub_0EC6
; calls (intra): sub_01D6
;----------------------------------------------------------------------
L_24B2:
        mov     ds, word ptr cs:[0x25f5]        ; 2E 8E 1E F5 25
        mov     byte ptr [0xc9], 0              ; C6 06 C9 00 00
        ret                                     ; C3
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
        inc     bp                              ; 45
        ...
        xchg    byte ptr [0xda], cl             ; 86 0E DA 00
        jcxz    L_255D                          ; E3 65
        mov     byte ptr [0xc8], 0x80           ; C6 06 C8 00 80
        pushf                                   ; 9C
        cli                                     ; FA
        xor     ax, ax                          ; 33 C0
        xchg    word ptr [0xd6], ax             ; 87 06 D6 00
        add     word ptr [0xd2], ax             ; 01 06 D2 00
        xor     ax, ax                          ; 33 C0
        xchg    word ptr [0xd8], ax             ; 87 06 D8 00
        add     word ptr [0xd4], ax             ; 01 06 D4 00
        sti                                     ; FB
        ...
        sub     word ptr [0xd2], ax             ; 29 06 D2 00
        mov     ax, word ptr [2]                ; A1 02 00
        mov     word ptr [0xd8], ax             ; A3 D8 00
        sub     word ptr [0xd4], ax             ; 29 06 D4 00
        mov     byte ptr [0xc8], 0x40           ; C6 06 C8 00 40
L_2550:
        jmp     L_2553                          ; EB 01
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2552 -- offset 0x2552 -- 163 instr
; Funcion compleja: 163 instrucciones, 1 llamadas, 4 branches.
; tags: complex, far
; calls (intra): sub_015D
;----------------------------------------------------------------------
L_2552:
        iret                                    ; CF
L_2553:
        ...
        mov     byte ptr es:[0xda], 1           ; 26 C6 06 DA 00 01
L_255D:
        pop     di                              ; 5F
        pop     si                              ; 5E
        sub     bp, 2                           ; 83 ED 02
...
L_2628:
        ...
        mov     bx, word ptr [bp + 6]           ; 8B 5E 06
        sub     bx, word ptr [0xd8]             ; 2B 1E D8 00
        mov     word ptr [0xd4], bx             ; 89 1E D4 00
        xor     cx, cx                          ; 33 C9
        xchg    byte ptr [0xda], cl             ; 86 0E DA 00
L_2680:
        jmp     L_2683                          ; EB 01
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2682 -- offset 0x2682 -- 15 instr
...
L_2683:
        ...
        jae     L_26AF                          ; 73 18
        je      L_26B6                          ; 74 1D
        or      byte ptr [0xc8], 0x40           ; 80 0E C8 00 40
        pushf                                   ; 9C
        sti                                     ; FB
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_26A5 -- offset 0x26A5 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: small
; calls (intra): sub_01B6
;----------------------------------------------------------------------
L_26A5:
        iret                                    ; CF
L_26A6:
        ...
        mov     ds, word ptr cs:[0x25f5]        ; 2E 8E 1E F5 25
L_26AF:
        mov     byte ptr [0xda], 1              ; C6 06 DA 00 01
        jmp     L_26E9                          ; EB 33
L_26B6:
        pushf                                   ; 9C
        sti                                     ; FB
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_26BD -- offset 0x26BD -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: wrapper
;----------------------------------------------------------------------
L_26BD:
...
L_26BE:
        ...
        mov     bx, word ptr [0xd4]             ; 8B 1E D4 00
        cmp     ax, word ptr [0x16]             ; 3B 06 16 00
        jne     L_2680                          ; 75 A8
        cmp     bx, word ptr [0x18]             ; 3B 1E 18 00
        jne     L_2680                          ; 75 A2
        mov     byte ptr [0xda], cl             ; 88 0E DA 00
        jmp     L_26E5                          ; EB 01
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_26E4 -- offset 0x26E4 -- 33 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_271F -- offset 0x271F -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; calls (intra): sub_01B6, sub_247A
;----------------------------------------------------------------------
L_271F:
        iret                                    ; CF
L_2720:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_273E -- offset 0x273E -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: wrapper
;----------------------------------------------------------------------
L_273E:
...
L_273F:
        ...
        mov     ds, word ptr cs:[0x25f5]        ; 2E 8E 1E F5 25
        mov     byte ptr [0xc8], 0              ; C6 06 C8 00 00
        pushf                                   ; 9C
        cli                                     ; FA
        mov     ax, word ptr [0xd2]             ; A1 D2 00
        mov     bx, word ptr [0xd4]             ; 8B 1E D4 00
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2769 -- offset 0x2769 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: small
; calls (intra): sub_01D6
;----------------------------------------------------------------------
...
L_276E:
        jmp     L_2792                          ; EB 22
L_2770:
        test    byte ptr [0xc8], 0x40           ; F6 06 C8 00 40
        jne     L_278D                          ; 75 16
        pushf                                   ; 9C
        sti                                     ; FB
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_277E -- offset 0x277E -- 54 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_27EE -- offset 0x27EE -- 28 instr
; Iterador con instrucciones de string (movsb/scasb/...) (28 instr).
...
L_2814:
        mov     bx, dx                          ; 8B DA
        mov     al, byte ptr [bx + 0x279e]      ; 8A 87 9E 27
        and     bl, 0xf                         ; 80 E3 0F
        mov     bl, byte ptr [bx + 0x27de]      ; 8A 9F DE 27
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_282C -- offset 0x282C -- 18 instr
