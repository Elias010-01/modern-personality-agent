; AUTO-GENERATED from original MSMOUSE2 segment 2
...
MSMOUSE2_DATA SEGMENT BYTE PUBLIC 'DATA'
        ...
        db      0d1h, 087h, 016h, 04ah, 000h, 039h, 016h, 04ah, 000h, 0c3h, 0f8h, 002h, 00bh, 0f7h ; D1 87 16 4A 00 39 16 4A 00 C3 F8 02 0B F7
