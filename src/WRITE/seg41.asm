...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_00B6 -- offset 0x00B6 -- 480 instr
; Iterador con instrucciones de string (movsb/scasb/...) (480 instr).
; tags: complex_iterator, far, loop, string_op
; calls (intra): sub_05A2, sub_0658
;----------------------------------------------------------------------
L_00B6:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0576 -- offset 0x0576 -- 24 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_05A2 -- offset 0x05A2 -- 74 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0658 -- offset 0x0658 -- 41 instr
