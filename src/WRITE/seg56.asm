...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0000 -- offset 0x0000 -- 110 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0127 -- offset 0x0127 -- 64 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01D0 -- offset 0x01D0 -- 99 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_02D5 -- offset 0x02D5 -- 261 instr
; Dispatcher: tabla de decisiones cmp+jcc (261 instr).
; tags: dispatcher, far
; callers: sub_06B4
; calls (intra): sub_05AF
;----------------------------------------------------------------------
L_02D5:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_05AF -- offset 0x05AF -- 96 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_06B4 -- offset 0x06B4 -- 642 instr
; Dispatcher: tabla de decisiones cmp+jcc (642 instr).
; tags: dispatcher, far
; calls (intra): sub_01D0, sub_02D5
;----------------------------------------------------------------------
L_06B4:
        push    ds                              ; 1E
        pop     ax                              ; 58
