...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0192 -- offset 0x0192 -- 13 instr
; Llama a servicios BIOS via INT 10h (video, 13 instr).
; tags: int_10, iterator, string_op
; callers: ENABLE
; calls (intra): sub_01CA
;----------------------------------------------------------------------
L_0192:
        mov     ah, 0xf                         ; B4 0F
        int     0x10                            ; CD 10
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01AF -- offset 0x01AF -- 12 instr
; Llama a servicios BIOS via INT 10h (video, 12 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01CA -- offset 0x01CA -- 735 instr
; Iterador con instrucciones de string (movsb/scasb/...) (735 instr).
; tags: complex_iterator, far, loop, string_op
; callers: sub_0192, sub_01AF
; calls (intra): sub_1A53, sub_1ADF, sub_1E2F
;----------------------------------------------------------------------
L_01CA:
        push    ax                              ; 50
        push    bx                              ; 53
...
;----------------------------------------------------------------------
; STRBLT -- 530 instr
; Iterador con instrucciones de string (movsb/scasb/...) (530 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0DC8 -- offset 0x0DC8 -- 22 instr
; Funcion sin clasificar definitiva (22 instr).
; tags: small
; callers: SETCURSOR
; calls (intra): sub_0E06
;----------------------------------------------------------------------
L_0DC8:
        cld                                     ; FC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0E06 -- offset 0x0E06 -- 17 instr
; Iterador con instrucciones de string (movsb/scasb/...) (17 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0E1E -- offset 0x0E1E -- 11 instr
; Funcion sin clasificar definitiva (11 instr).
; tags: small
; callers: sub_1CD2, sub_1D4C
; calls (intra): sub_0E73, sub_0EC4, sub_0F8D, sub_1022, sub_10BE
;----------------------------------------------------------------------
L_0E1E:
        mov     ax, ds                          ; 8C D8
        mov     es, ax                          ; 8E C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0E35 -- offset 0x0E35 -- 10 instr
; Wrapper que delega en sub_0E4C.
; tags: wrapper
; callers: SETCURSOR, sub_1A53, sub_1CAF, sub_1D96
; calls (intra): sub_0E4C
;----------------------------------------------------------------------
L_0E35:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0E4C -- offset 0x0E4C -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: small
; callers: sub_0E35, sub_10BE
; calls (intra): sub_11CC, sub_1200
;----------------------------------------------------------------------
L_0E4C:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0EC4 -- offset 0x0EC4 -- 15 instr
; Wrapper que delega en sub_0EE9.
; tags: wrapper
; callers: sub_0E1E
; calls (intra): sub_0EE9
;----------------------------------------------------------------------
L_0EC4:
        mov     ax, ds                          ; 8C D8
        mov     es, ax                          ; 8E C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0EE9 -- offset 0x0EE9 -- 40 instr
; Iterador con instrucciones de string (movsb/scasb/...) (40 instr).
; tags: iterator, loop, string_op
; callers: sub_0EC4
; calls (intra): sub_0F3B
;----------------------------------------------------------------------
L_0EE9:
        cmp     al, 3                           ; 3C 03
        jae     L_0F0F                          ; 73 22
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0F3B -- offset 0x0F3B -- 42 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0F8D -- offset 0x0F8D -- 28 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0FC8 -- offset 0x0FC8 -- 26 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1022 -- offset 0x1022 -- 65 instr
; Iterador con bucle (65 instr).
; tags: complex_iterator, loop
; callers: sub_0E1E
; calls (intra): sub_11FC
;----------------------------------------------------------------------
L_1022:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_10BE -- offset 0x10BE -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; callers: sub_0E1E
; calls (intra): sub_0E4C, sub_0FC8, sub_10DE, sub_116B
;----------------------------------------------------------------------
L_10BE:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_10DE -- offset 0x10DE -- 70 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_116B -- offset 0x116B -- 36 instr
; Dispatcher: tabla de decisiones cmp+jcc (36 instr).
; tags: dispatcher
; callers: sub_10BE
; calls (intra): sub_11CC
;----------------------------------------------------------------------
L_116B:
        xor     bp, bp                          ; 33 ED
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_11CC -- offset 0x11CC -- 23 instr
; Funcion sin clasificar definitiva (23 instr).
; tags: small
; callers: sub_0E4C, sub_116B
;----------------------------------------------------------------------
L_11CC:
        mov     cx, si                          ; 8B CE
        xchg    si, ax                          ; 96
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_11FC -- offset 0x11FC -- 1 instr
; Stub trivial (1 instrucciones, sin logica significativa).
; tags: trivial_stub
; callers: sub_1022, sub_10DE
;----------------------------------------------------------------------
L_11FC:
        mov     cx, word ptr [0x1c]             ; 8B 0E 1C 00
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1200 -- offset 0x1200 -- 2 instr
...
;----------------------------------------------------------------------
; OUTPUT -- 206 instr
; Iterador con instrucciones de string (movsb/scasb/...) (206 instr).
; tags: complex_iterator, far, string_op
; calls (intra): sub_15FB, sub_1680, sub_1A53, sub_1ADF, sub_1E2F
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_15FB -- offset 0x15FB -- 50 instr
; Dispatcher: tabla de decisiones cmp+jcc (50 instr).
; tags: dispatcher
; callers: OUTPUT, sub_1680
;----------------------------------------------------------------------
L_15FB:
        lds     si, ptr [bp + 0xa]              ; C5 76 0A
        mov     ax, word ptr [si + 2]           ; 8B 44 02
...
;----------------------------------------------------------------------
; ENUMOBJ -- 64 instr
; Enumerador: itera sobre obj.
; tags: far, medium
; calls (intra): sub_1835
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1835 -- offset 0x1835 -- 10 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; REALIZEOBJECT -- 34 instr
; Dispatcher: tabla de decisiones cmp+jcc (34 instr).
; tags: dispatcher, far
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1985 -- offset 0x1985 -- 2 instr
; Stub trivial (2 instrucciones, sin logica significativa).
; tags: trivial_stub
;----------------------------------------------------------------------
L_1985:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_198A -- offset 0x198A -- 70 instr
; Iterador con instrucciones de string (movsb/scasb/...) (70 instr).
; tags: complex_iterator, far, int_18, string_op
;----------------------------------------------------------------------
L_198A:
        xor     dh, dh                          ; 32 F6
        xor     bx, bx                          ; 33 DB
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1A53 -- offset 0x1A53 -- 26 instr
; Funcion sin clasificar definitiva (26 instr).
; tags: small
; callers: OUTPUT, PIXEL, SCANLR, STRBLT, sub_01CA, sub_1680
; calls (intra): sub_0E35, sub_1AA7
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1AA1 -- offset 0x1AA1 -- 4 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1ADF -- offset 0x1ADF -- 3 instr
; Stub trivial (3 instrucciones, sin logica significativa).
; tags: trivial_stub
; callers: OUTPUT, PIXEL, SCANLR, STRBLT, sub_01CA
;----------------------------------------------------------------------
L_1ADF:
        mov     ds, word ptr cs:[0x1c22]        ; 2E 8E 1E 22 1C
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1B7F -- offset 0x1B7F -- 72 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1CAF -- offset 0x1CAF -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: small
; calls (intra): sub_0E35, sub_1AA7
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1CD2 -- offset 0x1CD2 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: small
; calls (intra): sub_0E1E
;----------------------------------------------------------------------
L_1CD2:
        iret                                    ; CF
L_1CD3:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1CEA -- offset 0x1CEA -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: wrapper
;----------------------------------------------------------------------
L_1CEA:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1D11 -- offset 0x1D11 -- 11 instr
; Funcion sin clasificar definitiva (11 instr).
; tags: far, wrapper
;----------------------------------------------------------------------
L_1D11:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1D4C -- offset 0x1D4C -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; calls (intra): sub_0E1E, sub_1AA7
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1D6B -- offset 0x1D6B -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: wrapper
;----------------------------------------------------------------------
L_1D6B:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1D96 -- offset 0x1D96 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: small
; calls (intra): sub_0E35
;----------------------------------------------------------------------
L_1D96:
        iret                                    ; CF
L_1D97:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1DAB -- offset 0x1DAB -- 19 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1DD3 -- offset 0x1DD3 -- 44 instr
