...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0052 -- offset 0x0052 -- 185 instr
; Funcion compleja: 185 instrucciones, 4 llamadas, 8 branches.
; tags: calls_kernel, complex, far
; calls (intra): sub_0253, sub_04B8
; calls (inter): KERNEL.LOCKSEGMENT, KERNEL.UNLOCKSEGMENT
;----------------------------------------------------------------------
L_0052:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0253 -- offset 0x0253 -- 157 instr
; Dispatcher: tabla de decisiones cmp+jcc (157 instr).
; tags: dispatcher, far
; callers: sub_0052
;----------------------------------------------------------------------
L_0253:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_04B8 -- offset 0x04B8 -- 137 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_05F0 -- offset 0x05F0 -- 121 instr
