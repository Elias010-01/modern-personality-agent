...
BITS 16
    ...
    mov al, byte cs:[bx + 0x334]             ; 2E 8A 87 34 03
    ...
    mov al, byte cs:[bx + 0x346]             ; 2E 8A 87 46 03
    ...
    db 070h, 071h                     ; jo 0x3e2
    db 072h, 073h                     ; jb 0x3e6
    db 074h, 075h                     ; je 0x3ea
    db 076h, 077h                     ; jbe 0x3ee
    db 078h, 079h                     ; js 0x3f2
    nop                                      ; 90
    xchg cx, ax                              ; 91
    and al, 0x26                             ; 24 26
