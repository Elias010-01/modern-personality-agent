; AUTO-GENERATED from original SPAIN segment 2
...
L_0263:
        ...
        xor     ax, ax                          ; 33 C0
        xchg    byte ptr [0x417], al            ; 86 06 17 04
...
L_02A9:
        ...
        jb      L_0310                          ; 72 3F
        xor     bh, bh                          ; 32 FF
        mov     bh, byte ptr [bx + 0x40b]       ; 8A BF 0B 04
        ...
        cmp     al, bl                          ; 3A C3
        jne     L_02A4                          ; 75 B5
        mov     byte ptr [0x417], 1             ; C6 06 17 04 01
        jmp     L_02A4                          ; EB AE
L_02F6:
        mov     byte ptr [0x3b9], al            ; A2 B9 03
...
L_036E:
        ...
        cmp     al, ah                          ; 3A C4
        jne     L_036E                          ; 75 F4
        mov     byte ptr [0x3c1], al            ; A2 C1 03
        les     di, ptr [bp + 8]                ; C4 7E 08
        stosb   byte ptr es:[di], al            ; AA
        ...
        nop                                     ; 90
L_0387:
        mov     ah, byte ptr [0x3c1]            ; 8A 26 C1 03
        or      ah, ah                          ; 0A E4
        je      L_03D7                          ; 74 48
        mov     byte ptr [0x403], al            ; A2 03 04
        mov     bx, 0x3bd                       ; BB BD 03
L_0395:
        add     bx, 5                           ; 83 C3 05
        cmp     byte ptr [bx], al               ; 38 07
        jne     L_0395                          ; 75 F9
        ...
        je      L_03E3                          ; 74 41
        mov     byte ptr [0x3c1], 0             ; C6 06 C1 03 00
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0412 -- offset 0x0412 -- 14 instr
; Wrapper que delega en sub_0431.
; tags: wrapper
; callers: sub_0254
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0431 -- offset 0x0431 -- 10 instr
