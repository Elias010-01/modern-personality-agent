; AUTO-GENERATED from original NECP2 segment 2
; segment_size=4687 bytes, flags=0xf130
...
NECP2_TEXT SEGMENT BYTE PUBLIC 'CODE'
        ...
        mov     ds, ax                          ; 8E D8
        sub     sp, 4                           ; 83 EC 04
        cmp     word ptr [0x10c], 0             ; 83 3E 0C 01 00
        je      L_0019                          ; 74 05
L_0014:
        sub     ax, ax                          ; 2B C0
        jmp     L_00DF                          ; E9 C6 00
L_0019:
        mov     word ptr [0x10c], 1             ; C7 06 0C 01 01 00
        push    word ptr [bp + 8]               ; FF 76 08
        push    word ptr [bp + 6]               ; FF 76 06
        mov     ax, 0x430                       ; B8 30 04
        push    ds                              ; 1E
        push    ax                              ; 50
...
L_003E:
        ...
        je      L_0086                          ; 74 30
L_0056:
        mov     word ptr [0x450], 0xa           ; C7 06 50 04 0A 00
        mov     word ptr [0x456], 0x10          ; C7 06 56 04 10 00
...
L_0086:
        ...
        cmp     ax, 2                           ; 3D 02 00
        jne     L_00AC                          ; 75 09
        mov     word ptr [0x10c], 0             ; C7 06 0C 01 00 00
        jmp     L_0014                          ; E9 68 FF
L_00AC:
        push    word ptr [bp + 8]               ; FF 76 08
        push    word ptr [bp + 6]               ; FF 76 06
...
L_0238:
        ...
        mov     al, byte ptr [bx + si + 0x370]  ; 8A 80 70 03
        sub     ah, ah                          ; 2A E4
        jmp     L_0267                          ; EB 02
L_0265:
        sub     ax, ax                          ; 2B C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0273 -- offset 0x0273 -- 44 instr
; Funcion mediana (44 instr, 0 calls).
; tags: medium
; callers: sub_0D53, sub_0F4A
;----------------------------------------------------------------------
L_0273:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x2c0]            ; A1 C0 02
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2c2]            ; A0 C2 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_0297:
        ...
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2c8]            ; A0 C8 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_02C1:
        ...
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2bc]            ; A0 BC 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_02E7:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x2c3]            ; A1 C3 02
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2c5]            ; A0 C5 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_030B:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x2c9]            ; A1 C9 02
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2cb]            ; A0 CB 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_0335:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x2bd]            ; A1 BD 02
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2bf]            ; A0 BF 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_04FC:
        cmp     byte ptr [0x2bc], 0             ; 80 3E BC 02 00
        je      L_0511                          ; 74 0E
        les     bx, ptr [bp + 0xe]              ; C4 5E 0E
...
L_055E:
        ...
        jmp     L_05A0                          ; EB 17
L_0589:
        mov     word ptr [bp - 0x3e], 0x164     ; C7 46 C2 64 01
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_05FB -- offset 0x05FB -- 132 instr
...
L_0648:
        ...
        mov     bx, ax                          ; 8B D8
        shl     bx, 1                           ; D1 E3
        mov     ax, word ptr [bx + 0x194]       ; 8B 87 94 01
        push    ds                              ; 1E
        push    ax                              ; 50
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_07A3 -- offset 0x07A3 -- 69 instr
; Funcion mediana (69 instr, 1 calls).
; tags: medium
; callers: sub_02E7
; calls (intra): sub_085F
;----------------------------------------------------------------------
L_07A3:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_085F -- offset 0x085F -- 225 instr
; Dispatcher: tabla de decisiones cmp+jcc (225 instr).
; tags: calls_kernel, dispatcher, far
; callers: sub_02E7, sub_07A3
; calls (intra): sub_0238, sub_0AB0, sub_0B86, sub_0D53
...
L_0B71:
        les     bx, ptr [bp + 0xa]              ; C4 5E 0A
        push    word ptr es:[bx + 0x40]         ; 26 FF 77 40
        call    far KERNEL.GLOBALUNLOCK         ; 9A A1 0C 00 00 [FIXUP]
        mov     ax, word ptr [bp + 4]           ; 8B 46 04
L_0B80:
        mov     sp, bp                          ; 8B E5
        pop     bp                              ; 5D
...
L_0C01:
        ...
        push    dx                              ; 52
        push    ax                              ; 50
        call    far KERNEL.GLOBALALLOC          ; 9A 23 0D 00 00 [FIXUP]
        mov     word ptr [bp - 0x10], ax        ; 89 46 F0
        or      ax, ax                          ; 0B C0
        jne     L_0C1E                          ; 75 08
        sub     ax, ax                          ; 2B C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0CB2 -- offset 0x0CB2 -- 66 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0D53 -- offset 0x0D53 -- 178 instr
; Dispatcher: tabla de decisiones cmp+jcc (178 instr).
; tags: dispatcher
; callers: sub_085F
; calls (intra): sub_0273, sub_02E7, sub_0F4A
;----------------------------------------------------------------------
L_0D53:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
L_0D67:
        ...
        mov     cx, word ptr [0x1a6]            ; 8B 0E A6 01
        add     ax, cx                          ; 03 C1
        mov     dx, ds                          ; 8C DA
        push    dx                              ; 52
        push    ax                              ; 50
        ...
        cwde                                    ; 98
        push    ax                              ; 50
        call    far _entry_107                  ; 9A F6 0E 00 00 [FIXUP]
        push    word ptr [bp + 0x18]            ; FF 76 18
        push    word ptr [bp + 0x16]            ; FF 76 16
        push    word ptr [bp + 6]               ; FF 76 06
        push    word ptr [bp + 4]               ; FF 76 04
        call    L_0273                          ; E8 D4 F4
        jmp     L_0DA9                          ; EB 08
L_0DA1:
...
L_0EE0:
        ...
        push    word ptr [bp + 0x12]            ; FF 76 12
        push    word ptr [bp + 0x10]            ; FF 76 10
        call    far _entry_107                  ; 9A 2D 0F 00 00 [FIXUP]
L_0EFA:
        cmp     word ptr [bp - 4], 0            ; 83 7E FC 00
        je      L_0F37                          ; 74 37
        push    word ptr [bp + 0x18]            ; FF 76 18
        ...
        cwde                                    ; 98
        push    ax                              ; 50
        call    far _entry_107                  ; 9A 60 0F 00 00 [FIXUP]
        mov     ax, word ptr [bp - 0xa]         ; 8B 46 F6
        cdq                                     ; 99
        jmp     L_0F43                          ; EB 0C
L_0F37:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0F4A -- offset 0x0F4A -- 202 instr
; Dispatcher: tabla de decisiones cmp+jcc (202 instr).
; tags: calls_kernel, dispatcher, far
; callers: sub_0D53
; calls (intra): sub_0273, sub_02E7, sub_0B86, sub_1173, sub_11AD
...
L_0F66:
        ...
        mov     ax, 1                           ; B8 01 00
        push    ax                              ; 50
        call    far _entry_107                  ; 9A A4 0F 00 00 [FIXUP]
        mov     ax, word ptr [bp + 6]           ; 8B 46 06
...
L_0F80:
        ...
        jle     L_0FBC                          ; 7E 2E
        mov     ax, word ptr [bp + 4]           ; 8B 46 04
        mov     word ptr [0x2b2], ax            ; A3 B2 02
        push    word ptr [bp + 0xc]             ; FF 76 0C
        push    word ptr [bp + 0xa]             ; FF 76 0A
        ...
        mov     ax, 4                           ; B8 04 00
        push    ax                              ; 50
        call    far _entry_107                  ; 9A B8 0F 00 00 [FIXUP]
        push    word ptr [bp + 0xc]             ; FF 76 0C
        push    word ptr [bp + 0xa]             ; FF 76 0A
        mov     ax, 0x1aa                       ; B8 AA 01
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     ax, 1                           ; B8 01 00
        push    ax                              ; 50
...
L_1040:
        ...
        sub     ax, ax                          ; 2B C0
        push    ax                              ; 50
        call    far _entry_108                  ; 9A 6D 10 00 00 [FIXUP]
        push    word ptr [bp + 0x22]            ; FF 76 22
        push    word ptr [bp + 0x20]            ; FF 76 20
        push    word ptr [bp + 0xc]             ; FF 76 0C
        push    word ptr [bp + 0xa]             ; FF 76 0A
        call    L_0273                          ; E8 13 F2
L_1060:
        push    word ptr [bp + 0x22]            ; FF 76 22
        push    word ptr [bp + 0x20]            ; FF 76 20
        push    word ptr [bp + 0x1e]            ; FF 76 1E
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1173 -- offset 0x1173 -- 26 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_11AD -- offset 0x11AD -- 63 instr
...
L_11CB:
        ...
        push    es                              ; 06
        push    bx                              ; 53
        mov     ax, word ptr [0x2cf]            ; A1 CF 02
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2d1]            ; A0 D1 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
        call    far _entry_107                  ; 9A 16 12 00 00 [FIXUP]
        les     bx, ptr [bp + 8]                ; C4 5E 08
...
L_11F8:
        ...
        push    es                              ; 06
        push    bx                              ; 53
        mov     ax, word ptr [0x2d5]            ; A1 D5 02
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2d7]            ; A0 D7 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
        call    far _entry_107                  ; 9A 3D 12 00 00 [FIXUP]
        les     bx, ptr [bp + 8]                ; C4 5E 08
...
L_1225:
        ...
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x2d4]            ; A0 D4 02
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
        call    far _entry_107                  ; 9A 8C 0D 00 00 [FIXUP]
        les     bx, ptr [bp + 8]                ; C4 5E 08
