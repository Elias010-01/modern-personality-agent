; AUTO-GENERATED from original SWEDEN segment 3
...
SWEDEN_DATA SEGMENT BYTE PUBLIC 'DATA'
        ...
        db      0dbh, 0e4h, 0c4h, 0ffh, 0dch, 0f6h, 0d6h, 0ffh, 0ddh, 0e5h, 0c5h, 01bh, 0deh, 0a8h, 05eh, 01dh ; DB E4 C4 FF DC F6 D6 FF DD E5 C5 1B DE A8 5E 1D
