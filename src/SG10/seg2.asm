; AUTO-GENERATED from original SG10 segment 2
...
SG10_TEXT SEGMENT BYTE PUBLIC 'CODE'
        ...
        mov     ds, ax                          ; 8E D8
        sub     sp, 4                           ; 83 EC 04
        cmp     word ptr [0x10a], 0             ; 83 3E 0A 01 00
        je      L_0019                          ; 74 05
L_0014:
        sub     ax, ax                          ; 2B C0
        jmp     L_00DF                          ; E9 C6 00
L_0019:
        mov     word ptr [0x10a], 1             ; C7 06 0A 01 01 00
...
L_003E:
        ...
        je      L_0086                          ; 74 30
L_0056:
        mov     word ptr [0x550], 0xa           ; C7 06 50 05 0A 00
        mov     word ptr [0x556], 0x10          ; C7 06 56 05 10 00
...
L_0086:
        ...
        cmp     ax, 2                           ; 3D 02 00
        jne     L_00AC                          ; 75 09
        mov     word ptr [0x10a], 0             ; C7 06 0A 01 00 00
        jmp     L_0014                          ; E9 68 FF
L_00AC:
        push    word ptr [bp + 8]               ; FF 76 08
        push    word ptr [bp + 6]               ; FF 76 06
...
L_011E:
        ...
        push    word ptr [bp + 0xe]             ; FF 76 0E
        push    word ptr [0x554]                ; FF 36 54 05
        mov     ax, 1                           ; B8 01 00
        push    ax                              ; 50
        call    far USER.CHECKDLGBUTTON         ; 9A 80 01 00 00 [FIXUP]
        push    word ptr [bp + 0xe]             ; FF 76 0E
        push    word ptr [0x556]                ; FF 36 56 05
        mov     ax, 1                           ; B8 01 00
        push    ax                              ; 50
...
L_019B:
        ...
        push    ax                              ; 50
        mov     ax, word ptr [bp + 0xa]         ; 8B 46 0A
        mov     word ptr [0x556], ax            ; A3 56 05
L_01E5:
        push    ax                              ; 50
...
L_0238:
        ...
        mov     al, byte ptr [bx + si + 0x410]  ; 8A 80 10 04
        sub     ah, ah                          ; 2A E4
        jmp     L_0267                          ; EB 02
L_0265:
        sub     ax, ax                          ; 2B C0
...
L_0273:
        ...
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x362]            ; A0 62 03
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_0297:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x366]            ; A1 66 03
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x368]            ; A0 68 03
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_02E7:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x363]            ; A1 63 03
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x365]            ; A0 65 03
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_030B:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x369]            ; A1 69 03
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x36b]            ; A0 6B 03
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_0335:
        ...
        push    word ptr [bp + 0xa]             ; FF 76 0A
        push    word ptr [bp + 8]               ; FF 76 08
        mov     ax, word ptr [0x35d]            ; A1 5D 03
        push    ds                              ; 1E
        push    ax                              ; 50
...
L_04FC:
        cmp     byte ptr [0x35c], 0             ; 80 3E 5C 03 00
        je      L_0511                          ; 74 0E
        les     bx, ptr [bp + 0xe]              ; C4 5E 0E
...
L_055E:
        ...
        jmp     L_05A0                          ; EB 17
L_0589:
        mov     word ptr [bp - 0x3e], 0x184     ; C7 46 C2 84 01
...
L_0648:
        ...
        mov     bx, ax                          ; 8B D8
        shl     bx, 1                           ; D1 E3
        mov     ax, word ptr [bx + 0x1d4]       ; 8B 87 D4 01
        push    ds                              ; 1E
        push    ax                              ; 50
...
L_0D90:
        ...
        mov     cx, word ptr [0x1ea]            ; 8B 0E EA 01
        add     ax, cx                          ; 03 C1
        mov     dx, ds                          ; 8C DA
        push    dx                              ; 52
        push    ax                              ; 50
...
L_10BF:
        ...
        mov     byte ptr [0x40b], al            ; A2 0B 04
        push    word ptr [bp + 0xc]             ; FF 76 0C
        push    word ptr [bp + 0xa]             ; FF 76 0A
...
L_13D0:
        ...
        push    es                              ; 06
        push    bx                              ; 53
        mov     ax, word ptr [0x36f]            ; A1 6F 03
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x371]            ; A0 71 03
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
...
L_13FD:
        ...
        push    es                              ; 06
        push    bx                              ; 53
        mov     ax, word ptr [0x375]            ; A1 75 03
        push    ds                              ; 1E
        push    ax                              ; 50
        mov     al, byte ptr [0x377]            ; A0 77 03
        sub     ah, ah                          ; 2A E4
        push    ax                              ; 50
