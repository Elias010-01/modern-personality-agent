...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATECOMPATIBLEDC -- 43 instr
; Crea DC compatible con otro (memoria).
; tags: far, medium
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; CREATEDC -- 2 instr
; Crea Device Context para un dispositivo.
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; INTERNALCREATEDC -- 502 instr
; Iterador con instrucciones de string (movsb/scasb/...) (502 instr).
; tags: calls_kernel, complex_iterator, far, string_op
; calls (intra): sub_0511, sub_11C0, sub_15CD, sub_1651, sub_1683, sub_1A12 (+3 mas)
; calls (inter): KERNEL.FREELIBRARY, KERNEL.GETPROCADDRESS, KERNEL.GETTEMPFILENAME, KERNEL.GLOBALALLOC, KERNEL.GLOBALLOCK, KERNEL.GLOBALUNLOCK (+3 mas)
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0500 -- offset 0x0500 -- 9 instr
; Iterador con instrucciones de string (movsb/scasb/...) (9 instr).
; tags: calls_kernel, iterator, string_op
; callers: DELETEDC, RESTOREDC, SAVEDC, sub_04CD
...
;----------------------------------------------------------------------
; SAVEDC -- 78 instr
; Guarda estado del DC.
; tags: complex_iterator, far, string_op
; calls (intra): sub_0500, sub_11C0, sub_15FE, sub_3718
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; RESTOREDC -- 69 instr
; Restaura estado guardado del DC.
; tags: dispatcher, far
; calls (intra): sub_0500, sub_1112, sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_06D7 -- offset 0x06D7 -- 8 instr
; Funcion hoja (no llama a otras, 8 instr): probable helper aritmetico/conversion.
; tags: leaf
; callers: RECTSTUFF, RESTOREVISRGN, SELECTVISRGN, sub_11F3
;----------------------------------------------------------------------
...
; calls (intra): sub_04CD, sub_0500, sub_085B, sub_3D1F
; calls (inter): KERNEL.FREELIBRARY, KERNEL.GLOBALFREE
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_085B -- offset 0x085B -- 10 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATEPENINDIRECT -- 20 instr
; Constructor: crea penindirect.
; tags: far, small
; calls (intra): sub_0C3F
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; CREATEPEN -- 25 instr
; Crea pen con estilo/grosor/color.
; tags: far, small
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATEBRUSHINDIRECT -- 73 instr
; Constructor: crea brushindirect.
; tags: calls_kernel, far, medium
; calls (intra): sub_0C3F
; calls (inter): KERNEL.GLOBALLOCK, KERNEL.GLOBALUNLOCK, KERNEL.LOCALFREE
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATESOLIDBRUSH -- 18 instr
; Crea brush solido de color.
; tags: far, small
; calls (intra): sub_09D6
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATEHATCHBRUSH -- 18 instr
; Crea brush con patron de rayado.
; tags: far, small
; calls (intra): sub_09D6
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATEPATTERNBRUSH -- 18 instr
; Crea brush desde bitmap.
; tags: far, small
; calls (intra): sub_09D6
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_09D6 -- offset 0x09D6 -- 12 instr
; Funcion sin clasificar definitiva (12 instr).
; tags: wrapper
; callers: CREATEHATCHBRUSH, CREATEPATTERNBRUSH, CREATESOLIDBRUSH
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATEFONTINDIRECT -- 24 instr
; Constructor: crea fontindirect.
; tags: far, small
; calls (intra): sub_0C3F, sub_15CD
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; CREATEFONT -- 54 instr
; Crea fuente con atributos.
; tags: far, medium
; calls (intra): sub_15CD
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATEBITMAPINDIRECT -- 126 instr
; Constructor: crea bitmapindirect.
; tags: calls_kernel, complex_iterator, far, string_op
; calls (intra): sub_15FE
; calls (inter): KERNEL.GLOBALALLOC, KERNEL.GLOBALFREE, KERNEL.GLOBALLOCK, KERNEL.GLOBALUNLOCK
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATECOMPATIBLEBITMAP -- 2 instr
; Crea bitmap compatible con DC.
; tags: far, trivial_stub
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0C3F -- offset 0x0C3F -- 27 instr
; Iterador con instrucciones de string (movsb/scasb/...) (27 instr).
; tags: iterator, string_op
; callers: CREATEBRUSHINDIRECT, CREATEFONTINDIRECT, CREATEPENINDIRECT
; calls (intra): sub_15FE
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETBITMAPDIMENSION -- 21 instr
; Setter: cambia bitmapdimension.
; tags: far, small
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETBITMAPDIMENSION -- 19 instr
; Getter: devuelve bitmapdimension.
; tags: far, leaf
;----------------------------------------------------------------------
...
; Setter: cambia dcorg.
; tags: far, medium
; calls (intra): sub_1112, sub_1C1B, sub_3138
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETWINDOWEXT -- 3 instr
; Setter: cambia windowext.
; tags: far, trivial_stub
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETVIEWPORTEXT -- 2 instr
; Setter: cambia viewportext.
; tags: far, trivial_stub
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETWINVIEWEXT -- 60 instr
; Setter: cambia winviewext.
; tags: far, medium
; calls (intra): sub_2DE7, sub_314B, sub_3721
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; SCALEEXT -- 55 instr
; Funcion mediana (55 instr, 1 calls).
; tags: far, medium
; calls (intra): sub_3721
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETNEARESTCOLOR -- 31 instr
; Getter: devuelve nearestcolor.
; tags: far, medium
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; SETBKCOLOR -- 47 instr
; Setter: cambia bkcolor.
; tags: far, medium
; calls (intra): sub_0F42, sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETTEXTCOLOR -- 34 instr
; Setter: cambia textcolor.
; tags: far, medium
; calls (intra): sub_0F42, sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0F42 -- offset 0x0F42 -- 35 instr
; Funcion mediana (35 instr, 2 calls).
; tags: medium
; callers: SETBKCOLOR, SETTEXTCOLOR
; calls (intra): sub_1651, sub_1683
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SELECTCLIPRGN -- 49 instr
; Funcion mediana (49 instr, 5 calls).
; tags: far, medium
; calls (intra): sub_1112, sub_11C0, sub_1C1B, sub_3718, sub_3B9D
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SELECTVISRGN -- 31 instr
; Funcion mediana (31 instr, 3 calls).
; tags: far, medium
; calls (intra): sub_06D7, sub_1112, sub_3B9D
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; RECTSTUFF -- 93 instr
; Funcion compleja: 93 instrucciones, 6 llamadas, 8 branches.
; tags: calls_kernel, complex, far
; calls (intra): sub_06D7, sub_1112, sub_3372, sub_3721, sub_3BCD
; calls (inter): KERNEL.LOCALFREE
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1112 -- offset 0x1112 -- 35 instr
; Funcion mediana (35 instr, 2 calls).
; tags: medium
; callers: OFFSETCLIPRGN, OFFSETVISRGN, RECTSTUFF, RESTOREDC, RESTOREVISRGN, SELECTCLIPRGN (+3 mas)
; calls (intra): sub_11A5, sub_3B9D
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; GETCLIPBOX -- 38 instr
; Getter: devuelve clipbox.
; tags: far, iterator, string_op
; calls (intra): sub_11A5, sub_347E
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_11A5 -- offset 0x11A5 -- 12 instr
; Funcion hoja (no llama a otras, 12 instr): probable helper aritmetico/conversion.
; tags: leaf
; callers: COMBINERGN, GETCLIPBOX, GETRGNBOX, OFFSETRGN, sub_1112
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_11C0 -- offset 0x11C0 -- 29 instr
; Funcion sin clasificar definitiva (29 instr).
; tags: far, small
; callers: INTERNALCREATEDC, SAVEDC, SAVEVISRGN, SELECTCLIPRGN
; calls (intra): sub_15FE, sub_3B9D
;----------------------------------------------------------------------
L_11C0:
        push    si                              ; 56
        mov     si, ax                          ; 8B F0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_11F3 -- offset 0x11F3 -- 90 instr
; Funcion compleja: 90 instrucciones, 6 llamadas, 9 branches.
; tags: calls_kernel, complex
; callers: OFFSETVISRGN
; calls (intra): sub_06D7, sub_16B5
; calls (inter): KERNEL.GLOBALFREE, KERNEL.GLOBALLOCK, KERNEL.GLOBALUNLOCK, KERNEL.LOCALFREE
;----------------------------------------------------------------------
L_11F3:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SELECTOBJECT -- 209 instr
; Cambia objeto activo en DC (pen, brush, font, bitmap).
; tags: calls_kernel, dispatcher, far
; calls (intra): sub_1112, sub_1863, sub_1A12, sub_2BC2, sub_3718, sub_3CB7
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; LOCKUNLOCK -- 122 instr
; Dispatcher: tabla de decisiones cmp+jcc (122 instr).
; tags: calls_kernel, dispatcher, far
; calls (inter): KERNEL.GLOBALLOCK, KERNEL.GLOBALUNLOCK, KERNEL.LOCKRESOURCE
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_15CD -- offset 0x15CD -- 28 instr
; Funcion sin clasificar definitiva (28 instr).
; tags: far, small
; callers: CREATEFONT, CREATEFONTINDIRECT, INTERNALCREATEDC, sub_2ED5
;----------------------------------------------------------------------
L_15CD:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_15FE -- offset 0x15FE -- 37 instr
; Funcion mediana (37 instr, 1 calls).
; tags: calls_kernel, far, medium
; callers: COMBINERGN, CREATEBITMAPINDIRECT, SAVEDC, sub_0C3F, sub_11C0, sub_1863 (+2 mas)
; calls (inter): KERNEL.GLOBALALLOC
;----------------------------------------------------------------------
L_15FE:
        mov     dx, word ptr [0x224]            ; 8B 16 24 02
L_1602:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1651 -- offset 0x1651 -- 13 instr
; Wrapper que delega en KERNEL.LOCKSEGMENT.
; tags: calls_kernel, wrapper
; callers: INTERNALCREATEDC, TEXTOUT, sub_0F42, sub_1863, sub_1A12, sub_1F4E
; calls (inter): KERNEL.LOCKSEGMENT
;----------------------------------------------------------------------
L_1651:
        push    ax                              ; 50
        push    bx                              ; 53
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1662 -- offset 0x1662 -- 23 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1683 -- offset 0x1683 -- 13 instr
; Wrapper que delega en KERNEL.UNLOCKSEGMENT.
; tags: calls_kernel, wrapper
; callers: INTERNALCREATEDC, TEXTOUT, sub_0F42, sub_1863, sub_1A12, sub_1F4E
; calls (inter): KERNEL.UNLOCKSEGMENT
;----------------------------------------------------------------------
L_1683:
        push    ax                              ; 50
        push    bx                              ; 53
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1694 -- offset 0x1694 -- 23 instr
; Funcion sin clasificar definitiva (23 instr).
; tags: calls_kernel, far, small
; callers: sub_286C
; calls (inter): KERNEL.UNLOCKSEGMENT
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_16B5 -- offset 0x16B5 -- 10 instr
; Wrapper que delega en KERNEL.LOCALFREE.
; tags: calls_kernel, wrapper
; callers: UNREALIZEOBJECT, sub_11F3, sub_3D1F
; calls (inter): KERNEL.LOCALFREE
;----------------------------------------------------------------------
L_16B5:
        mov     si, bx                          ; 8B F3
...
;----------------------------------------------------------------------
; GETRGNBOX -- 32 instr
; Getter: devuelve rgnbox.
; tags: far, iterator, string_op
; calls (intra): sub_11A5
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1863 -- offset 0x1863 -- 180 instr
; Iterador con instrucciones de string (movsb/scasb/...) (180 instr).
; tags: calls_kernel, complex_iterator, string_op
; callers: SELECTOBJECT
; calls (intra): sub_15FE, sub_1651, sub_1683
; calls (inter): KERNEL.GLOBALLOCK, KERNEL.GLOBALUNLOCK, KERNEL.LOCALFREE
;----------------------------------------------------------------------
L_1863:
        push    bp                              ; 55
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1A12 -- offset 0x1A12 -- 179 instr
; Iterador con instrucciones de string (movsb/scasb/...) (179 instr).
; tags: calls_kernel, complex_iterator, far, string_op
; callers: INTERNALCREATEDC, SELECTOBJECT
; calls (intra): sub_15FE, sub_1651, sub_1683, sub_333D
; calls (inter): KERNEL.LOCALFREE
;----------------------------------------------------------------------
L_1A12:
        mov     ax, ds                          ; 8C D8
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETBRUSHORG -- 21 instr
; Setter: cambia brushorg.
; tags: far, small
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; UNREALIZEOBJECT -- 41 instr
; Funcion mediana (41 instr, 1 calls).
; tags: far, medium
; calls (intra): sub_16B5
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1C1B -- offset 0x1C1B -- 45 instr
; Funcion mediana (45 instr, 0 calls).
; tags: medium
; callers: OFFSETRGN, OFFSETVISRGN, SELECTCLIPRGN, SETDCORG
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1C89 -- offset 0x1C89 -- 82 instr
; Iterador con instrucciones de string (movsb/scasb/...) (82 instr).
; tags: complex_iterator, far, string_op
; callers: PTVISIBLE
; calls (intra): sub_1D2D
;----------------------------------------------------------------------
L_1C89:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1D2D -- offset 0x1D2D -- 105 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1E37 -- offset 0x1E37 -- 120 instr
; Iterador con instrucciones de string (movsb/scasb/...) (120 instr).
; tags: complex_iterator, far, string_op
; callers: TEXTOUT, sub_1F4E
;----------------------------------------------------------------------
L_1E37:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1F4E -- offset 0x1F4E -- 340 instr
; Iterador con instrucciones de string (movsb/scasb/...) (340 instr).
; tags: complex_iterator, far, string_op
; callers: BITBLT, PATBLT, STRETCHBLT
; calls (intra): sub_1651, sub_1683, sub_1E37, sub_333D, sub_36B8
;----------------------------------------------------------------------
L_1F4E:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
;----------------------------------------------------------------------
; PATBLT -- 38 instr
; Pinta rectangulo con brush.
; tags: far, medium
; calls (intra): sub_1F4E, sub_36B8
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; BITBLT -- 27 instr
; Copia rectangulo de bits entre DCs (block transfer).
; tags: far, small
; calls (intra): sub_1F4E
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; STRETCHBLT -- 143 instr
; Copia con escalado.
; tags: complex_iterator, far, string_op
; calls (intra): sub_1F4E, sub_333D, sub_36B8
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; TEXTOUT -- 168 instr
; Dibuja string en (x,y) con font del DC.
; tags: dispatcher, far
; calls (intra): sub_1651, sub_1683, sub_1E37, sub_2BC2, sub_333D, sub_36B8
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETTEXTEXTENT -- 21 instr
; Calcula tamano (cx,cy) que ocupa un string.
; tags: far, small
; calls (intra): sub_26D6
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETCONTINUINGTEXTEXTENT -- 21 instr
; Getter: devuelve continuingtextextent.
; tags: far, small
; calls (intra): sub_26D6
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_26D6 -- offset 0x26D6 -- 159 instr
; Dispatcher: tabla de decisiones cmp+jcc (159 instr).
; tags: dispatcher
; callers: GETCONTINUINGTEXTEXTENT, GETTEXTEXTENT
; calls (intra): sub_286C, sub_2BC2
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_286C -- offset 0x286C -- 76 instr
; Dispatcher: tabla de decisiones cmp+jcc (76 instr).
; tags: dispatcher, far
; callers: sub_26D6
; calls (intra): sub_1662, sub_1694
;----------------------------------------------------------------------
L_286C:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATERECTRGNINDIRECT -- 17 instr
; Constructor: crea rectrgnindirect.
; tags: far, small
; calls (intra): sub_3BCD
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; OFFSETCLIPRGN -- 54 instr
; Funcion mediana (54 instr, 2 calls).
; tags: far, medium
; calls (intra): sub_1112, sub_333D
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; OFFSETVISRGN -- 32 instr
; Funcion mediana (32 instr, 3 calls).
; tags: far, medium
; calls (intra): sub_1112, sub_11F3, sub_1C1B
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2BC2 -- offset 0x2BC2 -- 159 instr
; Dispatcher: tabla de decisiones cmp+jcc (159 instr).
; tags: calls_kernel, dispatcher, far
; callers: INTERNALCREATEDC, SELECTOBJECT, TEXTOUT, sub_26D6
; calls (inter): KERNEL.GLOBALUNLOCK, KERNEL.LOCALLOCK, KERNEL.LOCALUNLOCK, KERNEL.LOCKRESOURCE, KERNEL.YIELD
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; MULDIV -- 50 instr
; Funcion mediana (50 instr, 0 calls).
; tags: far, medium
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2DE7 -- offset 0x2DE7 -- 75 instr
; Funcion mediana (75 instr, 0 calls).
; tags: medium
; callers: SETWINVIEWEXT
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2EC4 -- offset 0x2EC4 -- 8 instr
; Iterador con bucle (8 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2ED5 -- offset 0x2ED5 -- 61 instr
; Funcion mediana (61 instr, 4 calls).
; tags: calls_kernel, far, medium
; callers: INTERNALCREATEDC
; calls (intra): sub_15CD
; calls (inter): KERNEL.ADDATOM, KERNEL.ANSIPREV, KERNEL.FINDATOM
;----------------------------------------------------------------------
L_2ED5:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETSTOCKOBJECT -- 9 instr
; Devuelve objeto stock del sistema (BLACK_PEN, WHITE_BRUSH, etc).
; tags: far, wrapper
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETDEVICECAPS -- 24 instr
; Recupera capacidades del dispositivo.
; tags: far, small
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; GETBITMAPBITS -- 2 instr
; Getter: devuelve bitmapbits.
; tags: far, trivial_stub
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
; MOVETO -- 29 instr
; Mueve cursor de dibujo a (x,y).
; tags: far, small
; calls (intra): sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETPOLYFILLMODE -- 3 instr
; Setter: cambia polyfillmode.
; tags: far, trivial_stub
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETSTRETCHBLTMODE -- 3 instr
; Setter: cambia stretchbltmode.
; tags: far, trivial_stub
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3138 -- offset 0x3138 -- 7 instr
...
;----------------------------------------------------------------------
; SETMAPMODE -- 68 instr
; Setter: cambia mapmode.
; tags: complex_iterator, far, string_op
; calls (intra): sub_314B, sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETWINDOWORG -- 15 instr
; Setter: cambia windoworg.
; tags: far, wrapper
; calls (intra): sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; SETVIEWPORTORG -- 15 instr
; Setter: cambia viewportorg.
; tags: far, wrapper
; calls (intra): sub_3718
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_333D -- offset 0x333D -- 30 instr
; Funcion sin clasificar definitiva (30 instr).
; tags: far, small
; callers: OFFSETCLIPRGN, PTVISIBLE, RECTVISIBLE, STRETCHBLT, TEXTOUT, sub_1A12 (+1 mas)
; calls (intra): sub_3372
;----------------------------------------------------------------------
L_333D:
        mov     dx, 0x3372                      ; BA 72 33
L_3340:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3372 -- offset 0x3372 -- 34 instr
; Funcion mediana (34 instr, 1 calls).
; tags: medium
; callers: RECTSTUFF, sub_333D
; calls (intra): sub_33B5
;----------------------------------------------------------------------
L_3372:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_347E -- offset 0x347E -- 8 instr
; Wrapper que delega en sub_3493.
; tags: wrapper
; callers: GETCLIPBOX, sub_33B5
; calls (intra): sub_3493
;----------------------------------------------------------------------
L_347E:
        mov     ax, word ptr [si + 0x9c]        ; 8B 84 9C 00
        or      ax, word ptr [si + 0x9e]        ; 0B 84 9E 00
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3547 -- offset 0x3547 -- 51 instr
; Interrupt Service Routine (51 instrucciones, posible manejador de INT).
; tags: isr
; callers: sub_33B5, sub_3493
;----------------------------------------------------------------------
L_3547:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_35A8 -- offset 0x35A8 -- 105 instr
; Iterador con bucle (105 instr).
; tags: complex_iterator, loop
; callers: sub_33B5, sub_3493
; calls (intra): sub_3686
;----------------------------------------------------------------------
L_35A8:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3686 -- offset 0x3686 -- 29 instr
; Iterador con instrucciones de string (movsb/scasb/...) (29 instr).
; tags: far, iterator, string_op
; callers: sub_35A8
;----------------------------------------------------------------------
L_3686:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_36B8 -- offset 0x36B8 -- 49 instr
; Funcion mediana (49 instr, 0 calls).
; tags: far, medium
; callers: PATBLT, STRETCHBLT, TEXTOUT, sub_1F4E
;----------------------------------------------------------------------
L_36B8:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3718 -- offset 0x3718 -- 7 instr
; Funcion hoja (no llama a otras, 7 instr): probable helper aritmetico/conversion.
; tags: leaf
; callers: MOVETO, RESTOREDC, SAVEDC, SELECTCLIPRGN, SELECTOBJECT, SETBKCOLOR (+4 mas)
;----------------------------------------------------------------------
L_3718:
        pop     bx                              ; 5B
        pop     es                              ; 07
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3721 -- offset 0x3721 -- 98 instr
; Funcion compleja: 98 instrucciones, 0 llamadas, 5 branches.
; tags: complex, far
; callers: OFFSETORG, RECTSTUFF, SCALEEXT, SETWINVIEWEXT, WORDSET
;----------------------------------------------------------------------
L_3721:
        inc     bp                              ; 45
        push    bp                              ; 55
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_37E4 -- offset 0x37E4 -- 64 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3872 -- offset 0x3872 -- 228 instr
; Iterador con instrucciones de string (movsb/scasb/...) (228 instr).
; tags: complex_iterator, far, string_op
; callers: COMBINERGN
; calls (intra): sub_37E4
;----------------------------------------------------------------------
L_3872:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; COMBINERGN -- 115 instr
; Iterador con instrucciones de string (movsb/scasb/...) (115 instr).
; tags: calls_kernel, complex_iterator, far, string_op
; calls (intra): sub_11A5, sub_15FE, sub_3872, sub_3B9D
; calls (inter): KERNEL.LOCALFREE, KERNEL.LOCALREALLOC
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3B9D -- offset 0x3B9D -- 24 instr
; Funcion sin clasificar definitiva (24 instr).
; tags: calls_kernel, small
; callers: COMBINERGN, SELECTCLIPRGN, SELECTVISRGN, sub_1112, sub_11C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3BCD -- offset 0x3BCD -- 90 instr
; Iterador con instrucciones de string (movsb/scasb/...) (90 instr).
; tags: complex_iterator, far, string_op
; callers: CREATERECTRGN, CREATERECTRGNINDIRECT, RECTSTUFF
; calls (intra): sub_15FE
;----------------------------------------------------------------------
L_3BCD:
        xor     cx, cx                          ; 33 C9
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; CREATERECTRGN -- 32 instr
; Constructor: crea rectrgn.
; tags: far, iterator, string_op
; calls (intra): sub_3BCD
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3CB7 -- offset 0x3CB7 -- 55 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_3D1F -- offset 0x3D1F -- 380 instr
; Iterador con bucle (380 instr).
; tags: calls_kernel, complex_iterator, far, loop
; callers: DELETEDC
; calls (intra): sub_16B5, sub_4029
; calls (inter): KERNEL.FATALEXIT
;----------------------------------------------------------------------
L_3D1F:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_4029 -- offset 0x4029 -- 29 instr
; Funcion sin clasificar definitiva (29 instr).
; tags: small
; callers: sub_3D1F
;----------------------------------------------------------------------
