...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0000 -- offset 0x0000 -- 596 instr
; Iterador con instrucciones de string (movsb/scasb/...) (596 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_05B1 -- offset 0x05B1 -- 121 instr
; Iterador con instrucciones de string (movsb/scasb/...) (121 instr).
...
;----------------------------------------------------------------------
; LINETO -- 54 instr
; Dibuja linea desde cursor a (x,y).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_08AC -- offset 0x08AC -- 144 instr
; Funcion compleja: 144 instrucciones, 3 llamadas, 7 branches.
; tags: calls_kernel, complex
; callers: sub_0000
; calls (intra): sub_0A21, sub_0B52
; calls (inter): KERNEL.LOCALFREE
;----------------------------------------------------------------------
L_08AC:
        push    bp                              ; 55
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0A21 -- offset 0x0A21 -- 104 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0B52 -- offset 0x0B52 -- 211 instr
; Iterador con instrucciones de string (movsb/scasb/...) (211 instr).
; tags: complex_iterator, loop, string_op
; callers: sub_08AC
;----------------------------------------------------------------------
L_0B52:
