...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0000 -- offset 0x0000 -- 35 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_004E -- offset 0x004E -- 84 instr
; Funcion compleja: 84 instrucciones, 5 llamadas, 7 branches.
; tags: calls_kernel, complex, far
; callers: sub_06A5
; calls (intra): sub_0ACD
; calls (inter): KERNEL.GLOBALHANDLE, KERNEL.LOCALLOCK, KERNEL.LOCALREALLOC, KERNEL.LOCALUNLOCK
;----------------------------------------------------------------------
L_004E:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0109 -- offset 0x0109 -- 47 instr
; Funcion mediana (47 instr, 2 calls).
; tags: calls_gdi, far, medium
; callers: sub_016F
; calls (inter): GDI.INTERSECTCLIPRECT, GDI.SELECTOBJECT
;----------------------------------------------------------------------
L_0109:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_016F -- offset 0x016F -- 28 instr
; Funcion sin clasificar definitiva (28 instr).
; tags: far, small
; callers: sub_01C9, sub_05B6, sub_0A98
; calls (intra): sub_0109
;----------------------------------------------------------------------
L_016F:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01A1 -- offset 0x01A1 -- 18 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_01C9 -- offset 0x01C9 -- 362 instr
; Iterador con instrucciones de string (movsb/scasb/...) (362 instr).
; tags: calls_gdi, calls_kernel, complex_iterator, far, string_op
; callers: sub_06A5
; calls (intra): sub_016F, sub_01A1, sub_051E, sub_06A5, sub_0A98, sub_0ACD
; calls (inter): GDI.GETSTOCKOBJECT, GDI.GETTEXTMETRICS, KERNEL.GLOBALHANDLE, KERNEL.LOCALFREE, KERNEL.LOCALLOCK, KERNEL.LOCALUNLOCK (+1 mas)
;----------------------------------------------------------------------
L_01C9:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_051E -- offset 0x051E -- 60 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_05B6 -- offset 0x05B6 -- 117 instr
; Dispatcher: tabla de decisiones cmp+jcc (117 instr).
; tags: dispatcher, far
; callers: sub_0703
; calls (intra): sub_016F, sub_01A1, sub_0873, sub_087C
;----------------------------------------------------------------------
L_05B6:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_06A5 -- offset 0x06A5 -- 49 instr
; Funcion mediana (49 instr, 3 calls).
; tags: calls_kernel, far, medium
; callers: sub_01C9
; calls (intra): sub_004E, sub_01C9
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0703 -- offset 0x0703 -- 158 instr
; Dispatcher: tabla de decisiones cmp+jcc (158 instr).
; tags: dispatcher, far
; callers: sub_087C
; calls (intra): sub_05B6, sub_0873
;----------------------------------------------------------------------
L_0703:
        mov     ax, ds                          ; 8C D8
        nop                                     ; 90
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_087C -- offset 0x087C -- 205 instr
; Iterador con instrucciones de string (movsb/scasb/...) (205 instr).
; tags: complex_iterator, string_op
; callers: sub_05B6
; calls (intra): sub_0703, sub_0A67, sub_0ACD
;----------------------------------------------------------------------
L_087C:
        mov     ax, dx                          ; 8B C2
        cmp     ax, di                          ; 3B C7
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0A67 -- offset 0x0A67 -- 21 instr
; Funcion sin clasificar definitiva (21 instr).
; tags: small
; callers: sub_0000, sub_087C
;----------------------------------------------------------------------
L_0A67:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0A98 -- offset 0x0A98 -- 25 instr
; Funcion sin clasificar definitiva (25 instr).
; tags: small
; callers: sub_01C9
; calls (intra): sub_016F, sub_01A1
;----------------------------------------------------------------------
L_0A98:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0ACD -- offset 0x0ACD -- 12 instr
; Funcion sin clasificar definitiva (12 instr).
; tags: small
; callers: sub_004E, sub_01C9, sub_087C
;----------------------------------------------------------------------
L_0ACD:
