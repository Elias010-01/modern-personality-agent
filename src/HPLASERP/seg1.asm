...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0000 -- offset 0x0000 -- 25 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0039 -- offset 0x0039 -- 215 instr
; Dispatcher: tabla de decisiones cmp+jcc (215 instr).
; tags: calls_gdi, calls_user, dispatcher
; calls (inter): GDI.STARTSPOOLPAGE, USER.SETRECT
;----------------------------------------------------------------------
L_0039:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
