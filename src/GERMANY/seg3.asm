...
BITS 16
    ...
    mov al, byte cs:[bx + 0x3d6]             ; 2E 8A 87 D6 03
    ...
    mov al, byte cs:[bx + 0x433]             ; 2E 8A 87 33 04
    ...
    xor sp, word [bx + 0x34ff]               ; 33 A7 FF 34
    xor al, 0x24                             ; 34 24
    push word [di]                           ; FF 35
    ...
    push sp                                  ; 54
    adc al, 0x55                             ; 14 55
    db 075h, 055h                     ; jne 0x386
    adc ax, 0x7656                           ; 15 56 76
    push si                                  ; 56
    push ss                                  ; 16
    push di                                  ; 57
    db 077h, 057h                     ; ja 0x390
    pop ss                                   ; 17
    pop ax                                   ; 58
    db 078h, 058h                     ; js 0x395
    ...
    db 0DDh                           ; DD
    cld                                      ; FC
    fcomp qword [bp + di]                    ; DC 1B
    fistp word [bp - 0x50]                   ; DF 5E B0
    push ds                                  ; 1E
    push 0x2a                                ; 6A 2A
    ...
    xor byte [bx + 0x8c0], bh                ; 30 BF C0 08
    ...
    db 070h, 071h                     ; jo 0x484
    db 072h, 073h                     ; jb 0x488
    db 074h, 075h                     ; je 0x48c
    db 076h, 077h                     ; jbe 0x490
    db 078h, 079h                     ; js 0x494
    nop                                      ; 90
    xchg cx, ax                              ; 91
    and al, 0x26                             ; 24 26
    ...
    inc word [bx + si]                       ; FF 00
    popaw                                    ; 61
    db 0E0h, 0E1h                     ; loopne 0x418
    db 0E2h, 0E4h                     ; loop 0x41d
    db 065h, 0E8h, 0E9h, 0EAh         ; call 0xffffef26
    db 0EBh, 069h                     ; jmp 0x4a8
    in al, dx                                ; EC
    in ax, dx                                ; ED
    out dx, al                               ; EE
    out dx, ax                               ; EF
    ...
    db 0FFh                           ; FF
    db 0FFh                           ; FF
    jmp word [bx + 0x68]                     ; FF 67 68
    imul bp, word [di + 0x64], 0x6665        ; 69 6D 64 65 66
    imul sp, word [bx + di + 0x62], 0x63     ; 6B 61 62 63
    pushaw                                   ; 60
    db 06Eh                           ; outsb dx, byte [si]
    db 0DBh, 0DCh                     ; fcmovnu st(0), st(4)
    db 0DDh                           ; DD
