; AUTO-GENERATED from original GERMANY segment 2
...
L_0279:
        ...
        xor     ax, ax                          ; 33 C0
        xchg    byte ptr [0x497], al            ; 86 06 97 04
...
L_02BF:
        ...
        jb      L_0326                          ; 72 3F
        xor     bh, bh                          ; 32 FF
        mov     bh, byte ptr [bx + 0x48b]       ; 8A BF 8B 04
        ...
        cmp     al, bl                          ; 3A C3
        jne     L_02BA                          ; 75 B5
        mov     byte ptr [0x497], 1             ; C6 06 97 04 01
        jmp     L_02BA                          ; EB AE
L_030C:
        mov     byte ptr [0x3d3], al            ; A2 D3 03
        mov     bx, 0x3af                       ; BB AF 03
L_0312:
        add     bx, 3                           ; 83 C3 03
        ...
        jmp     L_034C                          ; EB 26
L_0326:
        mov     byte ptr [0x3ae], al            ; A2 AE 03
...
L_0384:
        ...
        cmp     al, ah                          ; 3A C4
        jne     L_0384                          ; 75 F4
        mov     byte ptr [0x433], al            ; A2 33 04
        les     di, ptr [bp + 8]                ; C4 7E 08
        stosb   byte ptr es:[di], al            ; AA
        ...
        nop                                     ; 90
L_039D:
        mov     ah, byte ptr [0x433]            ; 8A 26 33 04
        or      ah, ah                          ; 0A E4
        je      L_03ED                          ; 74 48
        mov     byte ptr [0x475], al            ; A2 75 04
        mov     bx, 0x42f                       ; BB 2F 04
L_03AB:
        add     bx, 5                           ; 83 C3 05
        cmp     byte ptr [bx], al               ; 38 07
        jne     L_03AB                          ; 75 F9
        ...
        je      L_03F9                          ; 74 41
        mov     byte ptr [0x433], 0             ; C6 06 33 04 00
