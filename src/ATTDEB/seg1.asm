...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0229 -- offset 0x0229 -- 63 instr
; Llama a servicios BIOS via INT 10h (video, 63 instr).
; tags: calls_kernel, complex_iterator, int_10, loop, string_op
; callers: sub_2322
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_02A8 -- offset 0x02A8 -- 1738 instr
; Llama a servicios BIOS via INT 10h (video, 1738 instr).
; tags: complex_iterator, int_10, loop, string_op
; callers: sub_2322
; calls (intra): sub_25D2
;----------------------------------------------------------------------
L_02A8:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1215 -- offset 0x1215 -- 22 instr
; Funcion sin clasificar definitiva (22 instr).
; tags: small
; callers: sub_224A
; calls (intra): sub_1253
;----------------------------------------------------------------------
L_1215:
        cld                                     ; FC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1253 -- offset 0x1253 -- 17 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_126B -- offset 0x126B -- 11 instr
; Funcion sin clasificar definitiva (11 instr).
; tags: small
; callers: sub_2475, sub_24EF
; calls (intra): sub_12C0, sub_12FD, sub_13B2, sub_1447, sub_14E3
;----------------------------------------------------------------------
L_126B:
        mov     ax, ds                          ; 8C D8
        mov     es, ax                          ; 8E C0
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1282 -- offset 0x1282 -- 10 instr
; Wrapper que delega en sub_1299.
; tags: wrapper
; callers: sub_20F7, sub_224A, sub_2452, sub_2539
; calls (intra): sub_1299
;----------------------------------------------------------------------
L_1282:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1299 -- offset 0x1299 -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: small
; callers: sub_1282, sub_14E3
; calls (intra): sub_15F1, sub_1621
;----------------------------------------------------------------------
L_1299:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_12FD -- offset 0x12FD -- 89 instr
; Iterador con instrucciones de string (movsb/scasb/...) (89 instr).
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_13B2 -- offset 0x13B2 -- 28 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_13ED -- offset 0x13ED -- 26 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_14E3 -- offset 0x14E3 -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; callers: sub_126B
; calls (intra): sub_1299, sub_13ED, sub_1503, sub_1590
;----------------------------------------------------------------------
L_14E3:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1503 -- offset 0x1503 -- 70 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1590 -- offset 0x1590 -- 36 instr
; Dispatcher: tabla de decisiones cmp+jcc (36 instr).
; tags: dispatcher
; callers: sub_14E3
; calls (intra): sub_15F1
;----------------------------------------------------------------------
L_1590:
        xor     bp, bp                          ; 33 ED
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_15F1 -- offset 0x15F1 -- 21 instr
; Funcion sin clasificar definitiva (21 instr).
; tags: small
; callers: sub_1299, sub_1590
;----------------------------------------------------------------------
L_15F1:
        mov     cx, si                          ; 8B CE
        xchg    si, ax                          ; 96
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_161D -- offset 0x161D -- 1 instr
; Stub trivial (1 instrucciones, sin logica significativa).
; tags: trivial_stub
; callers: sub_1447, sub_1503
;----------------------------------------------------------------------
L_161D:
        mov     cx, word ptr [0x1c]             ; 8B 0E 1C 00
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1621 -- offset 0x1621 -- 579 instr
; Iterador con instrucciones de string (movsb/scasb/...) (579 instr).
; tags: complex_iterator, far, loop, string_op
; callers: sub_1299
; calls (intra): sub_1B5C, sub_1BBC, sub_20F7, sub_25D2
;----------------------------------------------------------------------
L_1621:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1B5C -- offset 0x1B5C -- 36 instr
; Dispatcher: tabla de decisiones cmp+jcc (36 instr).
; tags: dispatcher
; callers: sub_1621
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1BBC -- offset 0x1BBC -- 251 instr
; Iterador con instrucciones de string (movsb/scasb/...) (251 instr).
; tags: complex_iterator, far, loop, string_op
; callers: sub_1621
;----------------------------------------------------------------------
L_1BBC:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1E06 -- offset 0x1E06 -- 49 instr
; Funcion mediana (49 instr, 1 calls).
; tags: medium
; callers: sub_1E84
; calls (intra): sub_1E84
;----------------------------------------------------------------------
L_1E06:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_1E84 -- offset 0x1E84 -- 177 instr
; Iterador con instrucciones de string (movsb/scasb/...) (177 instr).
; tags: complex_iterator, loop, string_op
; callers: sub_1E06
; calls (intra): sub_1E06, sub_202F, sub_20F2, sub_2576
;----------------------------------------------------------------------
L_1E84:
        push    si                              ; 56
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_202F -- offset 0x202F -- 90 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_20F2 -- offset 0x20F2 -- 2 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_20F7 -- offset 0x20F7 -- 156 instr
; Iterador con instrucciones de string (movsb/scasb/...) (156 instr).
; tags: complex_iterator, far, string_op
; callers: sub_1621
; calls (intra): sub_1282, sub_224A
;----------------------------------------------------------------------
L_20F7:
        push    cx                              ; 51
        xor     dh, dh                          ; 32 F6
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2244 -- offset 0x2244 -- 4 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_224A -- offset 0x224A -- 89 instr
; Dispatcher: tabla de decisiones cmp+jcc (89 instr).
; tags: dispatcher, far
; callers: sub_20F7, sub_2452, sub_24EF
; calls (intra): sub_1215, sub_1282
;----------------------------------------------------------------------
L_224A:
        mov     ds, word ptr cs:[0x23c5]        ; 2E 8E 1E C5 23
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2322 -- offset 0x2322 -- 161 instr
; Funcion compleja: 161 instrucciones, 2 llamadas, 3 branches.
; tags: complex, far
; calls (intra): sub_0229, sub_02A8
;----------------------------------------------------------------------
L_2322:
        iret                                    ; CF
L_2323:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2452 -- offset 0x2452 -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: small
; calls (intra): sub_1282, sub_224A
;----------------------------------------------------------------------
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2475 -- offset 0x2475 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: small
; calls (intra): sub_126B
;----------------------------------------------------------------------
L_2475:
        iret                                    ; CF
L_2476:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_248D -- offset 0x248D -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: wrapper
;----------------------------------------------------------------------
L_248D:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_24B4 -- offset 0x24B4 -- 33 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_24EF -- offset 0x24EF -- 14 instr
; Funcion sin clasificar definitiva (14 instr).
; tags: small
; calls (intra): sub_126B, sub_224A
;----------------------------------------------------------------------
L_24EF:
        iret                                    ; CF
L_24F0:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_250E -- offset 0x250E -- 15 instr
; Funcion sin clasificar definitiva (15 instr).
; tags: wrapper
;----------------------------------------------------------------------
L_250E:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2539 -- offset 0x2539 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: small
; calls (intra): sub_1282
;----------------------------------------------------------------------
L_2539:
        iret                                    ; CF
L_253A:
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_254E -- offset 0x254E -- 19 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_2576 -- offset 0x2576 -- 44 instr
