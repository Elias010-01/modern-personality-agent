...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0000 -- offset 0x0000 -- 29 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0047 -- offset 0x0047 -- 317 instr
; Dispatcher: tabla de decisiones cmp+jcc (317 instr).
; tags: calls_kernel, calls_user, dispatcher
; callers: sub_03E2
; calls (intra): sub_038D, sub_03E2, sub_0837
; calls (inter): KERNEL.OPENFILE, USER.GETFOCUS, USER.GETKEYSTATE, USER.POSTMESSAGE, USER.SENDMESSAGE, USER.SETCURSOR (+1 mas)
;----------------------------------------------------------------------
L_0047:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_038D -- offset 0x038D -- 33 instr
; Funcion mediana (33 instr, 2 calls).
; tags: calls_user, medium
; callers: sub_0047, sub_03E2
; calls (intra): sub_0837
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_03E2 -- offset 0x03E2 -- 283 instr
; Dispatcher: tabla de decisiones cmp+jcc (283 instr).
; tags: calls_user, dispatcher, far
; callers: sub_0047
; calls (intra): sub_0047, sub_038D, sub_0837, sub_0876, sub_09CC
; calls (inter): USER.BEGINPAINT, USER.DEFWINDOWPROC, USER.DESTROYWINDOW, USER.ENDPAINT, USER.GETCLIENTRECT, USER.ISICONIC (+4 mas)
;----------------------------------------------------------------------
L_03E2:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_06BB -- offset 0x06BB -- 48 instr
; Funcion mediana (48 instr, 5 calls).
; tags: calls_user, medium
; callers: sub_0A22
; calls (intra): sub_072E
; calls (inter): USER.DISPATCHMESSAGE, USER.GETMESSAGE, USER.TRANSLATEACCELERATOR, USER.TRANSLATEMESSAGE
;----------------------------------------------------------------------
L_06BB:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_072E -- offset 0x072E -- 108 instr
; Dispatcher: tabla de decisiones cmp+jcc (108 instr).
; tags: calls_kernel, calls_user, dispatcher, far
; callers: sub_06BB
; calls (intra): sub_0837
; calls (inter): KERNEL.ANSIUPPER, KERNEL.LSTRCPY, USER.ISICONIC, USER.MESSAGEBEEP, USER.SENDMESSAGE, USER.SETWINDOWTEXT
;----------------------------------------------------------------------
L_072E:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0837 -- offset 0x0837 -- 31 instr
; Funcion mediana (31 instr, 2 calls).
; tags: calls_user, far, medium
; callers: sub_0047, sub_038D, sub_03E2, sub_072E
; calls (intra): sub_0A22
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0876 -- offset 0x0876 -- 124 instr
; Dispatcher: tabla de decisiones cmp+jcc (124 instr).
; tags: calls_user, dispatcher
; callers: sub_03E2
; calls (inter): USER.CHECKMENUITEM, USER.CLOSECLIPBOARD, USER.ENABLEMENUITEM, USER.ENUMCLIPBOARDFORMATS, USER.GETMENU, USER.GETSUBMENU (+2 mas)
;----------------------------------------------------------------------
L_0876:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_09CC -- offset 0x09CC -- 36 instr
; Funcion mediana (36 instr, 3 calls).
; tags: calls_gdi, calls_user, far, medium
; callers: sub_03E2
; calls (inter): GDI.DELETEDC, USER.ENABLEMENUITEM, USER.GETMENU
;----------------------------------------------------------------------
L_09CC:
        push    ds                              ; 1E
        pop     ax                              ; 58
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0A22 -- offset 0x0A22 -- 157 instr
; Llama a servicios DOS via INT 21h (157 instr).
; tags: calls_kernel, calls_user, complex_iterator, far, int_21, string_op
; callers: sub_0837
; calls (intra): sub_06BB, sub_0C7E, sub_0D10
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0C7E -- offset 0x0C7E -- 59 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0D10 -- offset 0x0D10 -- 8 instr
; Funcion sin clasificar definitiva (8 instr).
; tags: small
; callers: sub_0A22
; calls (intra): sub_0D2B, sub_0D61
;----------------------------------------------------------------------
L_0D10:
        push    bp                              ; 55
        mov     bp, sp                          ; 8B EC
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0D20 -- offset 0x0D20 -- 6 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0D61 -- offset 0x0D61 -- 10 instr
...
; @ANALYSIS_v1
;----------------------------------------------------------------------
; sub_0D73 -- offset 0x0D73 -- 10 instr
; Funcion sin clasificar definitiva (10 instr).
; tags: wrapper
; callers: sub_0D2B
;----------------------------------------------------------------------
