...
`.EXE` / `.DRV` files of Microsoft Windows 1.03 (1985) and regenerate them
**byte-for-byte identical** from **human-readable, editable assembly source**,
with every function documented automatically.
...
`.EXE` / `.DRV` originales de Microsoft Windows 1.03 (1985) y regenerarlos
**byte-exactos** desde **código fuente assembly humano-legible y editable**,
