...
- Funciones: **45**
- Confidence: high=0, medium=20, low=11, unknown=14
...
| `0x277E` | `sub_277E` | FAR | 19 | Funcion sin clasificar definitiva (19 instr). | unknown |
| `0x27A6` | `sub_27A6` | NEAR | 44 | Iterador con instrucciones de string (movsb/scasb/...) (44 instr). | medium |
| `0x2802` | `sub_2802` | NEAR | 18 | Funcion hoja (no llama a otras, 18 instr): probable helper aritmetico/conversion. | low |
