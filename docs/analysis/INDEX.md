...
- **Confidence**:
    - high (known API): **145**
    - medium (convention or pattern): **1864**
    - low (generic heuristic): **1198**
    - unknown: **747**
...
## Reference symbols (starfrost013 debug build)

Names of known internal functions from the **debug** build of Windows 1.03 (KERNEL/USER/GDI), shared by [@starfrost013](https://github.com/starfrost013/modern-personality-research). Offsets are debug-build offsets, not directly comparable to our retail offsets, but the names are a useful vocabulary.

- [GDI reference symbols](GDI_starfrost_symbols.md)
- [KERNEL reference symbols](KERNEL_starfrost_symbols.md)
- [USER reference symbols](USER_starfrost_symbols.md)
