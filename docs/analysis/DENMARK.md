...
- Funciones: **6**
- Confidence: high=0, medium=4, low=1, unknown=1
...
| `0x013A` | `sub_013A` | NEAR | 138 | Iterador con instrucciones de string (movsb/scasb/...) (138 instr). | medium |
| `0x0222` | `sub_0222` | FAR | 27 | Iterador con instrucciones de string (movsb/scasb/...) (27 instr). | medium |
